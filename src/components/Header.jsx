...
export default function Header() {
  ...
  return (
    <header
      className={`sticky top-0 z-40 border-b border-gray-100 bg-white transition-transform duration-300 ${
    ...
    >
      ...
      <nav className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between gap-4">
        ...
        <div className="hidden lg:flex items-center justify-between flex-1 gap-4">
          ...
          <Link
            to="/application-form"
            className="bg-red-600 hover:bg-red-700 text-white font-semibold text-sm px-7 py-3 rounded-xl shadow-sm"
          >
            Apply / Inquire Now
          </Link>
        </div>
      ...
      >
        <div className="px-6 py-4">
          ...
          <Link
            to="/application-form"
            className="mt-4 inline-block w-full text-center bg-red-600 hover:bg-red-700 text-white font-semibold text-sm px-6 py-3 rounded-xl"
